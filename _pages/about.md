...
My current research focuses on relaxing permutation equivariance in *Graph Neural Networks* and also leveraging *Quantum Machine Learning* to go beyond the deterministic limit of the Weisfeiler-Lehman test for GNNs.